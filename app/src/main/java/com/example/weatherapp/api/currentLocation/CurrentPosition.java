...
public class CurrentPosition {
    ...
    public CurrentPosition(Integer version, String key, String type, Integer rank, String localizedName, String englishName, String primaryPostalCode, Region region, Country country, AdministrativeArea administrativeArea, TimeZone timeZone, GeoPosition geoPosition, Boolean isAlias, ParentCity parentCity, List<SupplementalAdminArea> supplementalAdminAreas, List<String> dataSets) {
        super();
